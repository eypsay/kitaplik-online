package com.sayilir.coder.bookservice;
...
public class BookServiceApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Book book1 = new Book("Dünyanın  Gözü", 2000, "Robert Rober", "Beta", "123456");
        Book book2 = new Book("Yüzüklerin Efendisi", 1960, "J.R.R Tolkien", "Beta", "456789");
        Book book3 = new Book("Harry Poter", 1997, "J. K. K ", "Beta", "987654");
