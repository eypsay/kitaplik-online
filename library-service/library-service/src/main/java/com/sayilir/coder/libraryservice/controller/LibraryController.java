package com.sayilir.coder.libraryservice.controller;

import com.sayilir.coder.libraryservice.dto.AddBookRequest;
import com.sayilir.coder.libraryservice.dto.LibraryDto;
import com.sayilir.coder.libraryservice.service.LibraryService;
...
public class LibraryController {
    ...
    public ResponseEntity<String> getCount() {
        return ResponseEntity.ok("libary service count : " + count);
    }
